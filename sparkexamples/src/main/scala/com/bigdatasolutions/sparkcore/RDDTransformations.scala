...
object RDDTransformations {
  ...
  def main(args: Array[String]) {
    ...
    val inputLine = sc.parallelize(List("hello veera", "hi"))
    ...
    /**
      ...
      */
    //val flatMapLines = sc.parallelize(List("hello veera", "hi"))
